(async () => {
    ...
    class ForChart{
        constructor(adress,type,lineTension,backgroundColor,borderWidth, borderColor, pointBackgroundColor){
            this.adress=adress;
            this.type=type;
        ...
        makechart(){
            const{adress,type,lineTension,backgroundColor,borderWidth,borderColor,pointBackgroundColor}=this;
            new Chart(adress,
                {
                    type:type,
                    data: {
 ...
 const cart=new ForChart(ctx,"line",0,"transparent",4, "#007bff", "#007bff");
 await cart.makechart();
  })();